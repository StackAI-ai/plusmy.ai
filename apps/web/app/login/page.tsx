...
export default function LoginPage() {
  return (
    <div className="grid gap-6 md:grid-cols-[1.2fr_1fr]">
      <section className="rounded-[36px] border border-black/5 bg-white/70 p-8 shadow-panel">
        <p className="text-sm uppercase tracking-[0.24em] text-slate-500">Workspace access</p>
